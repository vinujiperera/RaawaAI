  ...
  return (
    <div className="relative flex flex-col items-center justify-center px-4 text-center min-h-[calc(100vh-64px)] pb-12">
      ...
      <button
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center text-slate-600 hover:text-[#49C5E0] transition-colors group animate-bounce"
      >
        <ChevronDown size={20} />
      </button>
    </div>
